...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-300 via-yellow-200 to-blue-300">
      <div className="relative w-[360px] bg-white bg-opacity-20 rounded-xl shadow-xl backdrop-blur-md px-8 py-10 boder border-red">
        ...
        <h2 className="text-center text-white text-xl font-semibold mb-6 mt-6">Register Form</h2>
