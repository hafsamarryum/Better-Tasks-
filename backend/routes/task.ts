...
import { createTask, deleteTask, getActivitiesForTask, getAllTasks, getDashboardStats, getMyTasks, updateAssignee, updateTask, updateTaskStatus } from "../Controller/taskController";
...
taskRoutes.get("/dashboardStats", [authMiddleware as any], getDashboardStats as any);
